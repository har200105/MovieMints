  ...
  return (
    <ModalContainer visible={visible}>
      ...
      {!videoSelected ? (
        ...
        <MovieForm busy={busy} onSubmit={!busy ? handleSubmit : null} btnTitle="Submit" />
      )}
    </ModalContainer>
  );
}

const TrailerSelector = ({ visible, handleChange, onTypeError , onBlur}) => {
  if (!visible) return null;

  return (
    <div className="h-full flex items-center justify-center" onBlur={onBlur}>
      <FileUploader
        handleChange={handleChange}
