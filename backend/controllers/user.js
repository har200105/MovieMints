...
exports.verifyEmail = async (req, res) => {
  ...
  transport.sendMail({
    ...
    html: "<h1>Welcome to our app and thanks for choosing us, Your email is verified.</h1>",
  });
...
exports.forgetPassword = async (req, res) => {
  ...
  const resetPasswordUrl = `${process.env.FRONTEND_URL}/auth/reset-password?token=${token}&id=${user._id}`;
